  ...
  return (
    ...
    >
      <div className="flex p-4">
        <div className="h-5 w-5 rounded-md bg-zinc-700/60" />
        <div className="ml-2 h-6 w-16 rounded-md bg-zinc-700/60 text-sm font-medium" />
      </div>
      <div className="flex items-center justify-center truncate rounded-xl bg-zinc-700/60 px-4 py-8">
        <div className="h-7 w-20 rounded-md bg-zinc-800" />
      </div>
    </div>
  );
}
    ...
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4 bg-zinc-800/60 p-2 rounded-xl`}>
      ...
      <div className="rounded-xl bg-zinc-700/60 p-4">
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <div className="ml-2 h-4 w-20 rounded-md bg-zinc-800" />
        </div>
      </div>
    </div>
  );
    ...
    <div className="flex flex-row items-center justify-between bg-zinc-800 py-3 mb-1 px-2 rounded-md">
      <div className="flex items-center">
        ...
        <div className="min-w-0">
          <div className="h-5 w-40 rounded-md bg-zinc-700/60" />
          <div className="mt-2 h-4 w-12 rounded-md bg-zinc-700/60" />
        </div>
      </div>
      <div className="mt-2 h-4 w-12 rounded-md bg-zinc-700/60" />
    </div>
...
export default function DashboardSkeleton() {
  return (
    <>
      <div
        className={`${shimmer} relative mb-4 h-8 w-36 overflow-hidden rounded-md bg-zinc-700/80`}
      />
